...
LOCA_NOTARY_PROFILE=loca-notary ./scripts/package-universal.sh v0.1.2

# Alternative: notarize with ASC API key env vars instead of keychain profile
# LOCA_NOTARY_KEY_ID=... LOCA_NOTARY_ISSUER_ID=... LOCA_NOTARY_KEY_BASE64_PATH=... ./scripts/package-universal.sh v0.1.2
```

This produces `dist/loca-0.1.2-universal-macos.tar.gz` for GitHub Releases/Homebrew.
